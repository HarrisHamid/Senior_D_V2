  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, hsl(351, 63%, 37%), hsl(0, 80%, 52%))",
        }}
      />
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            <span
              className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium"
              style={{
                background: project.internal
                  ? "linear-gradient(180deg, #eff6ff 0%, #dbeafe 100%)"
                  : "linear-gradient(180deg, #fdf4ff 0%, #f3e8ff 100%)",
                border: project.internal ? "1px solid #bfdbfe" : "1px solid #e9d5ff",
                color: project.internal ? "#1d4ed8" : "#7e22ce",
              }}
            >
